            ...
            <View style={styles.container}>
                ...
                <View style={styles.lowerContainer}>
                    ...
                    <View style={styles.containerButton}>
                        <TouchableOpacity style={[styles.button, { backgroundColor: '#FFE4E4' }]}
                            onPress={() => this.props.navigation.navigate("fisico")}></TouchableOpacity>
                        <View style={styles.containerSlider} >
                            <View style={styles.containerText}>
                                <Text style={styles.textTextFisico}> Físico</Text>
                            </View>
                    ...
                    <View style={styles.containerButton}>
                        ...
                        <View style={styles.containerSlider} >
                            <View style={styles.containerText}>
                                <Text style={styles.textText}> Ação</Text>
                            </View>
                            <Slider
                                style={{ width: 200, height: 40 }}
                                value={this.state.ação}
                                minimumValue={0}
                                maximumValue={100}
                                thumbTintColor="#96B5A6"
                                minimumTrackTintColor="#96B5A6"
                                maximumTrackTintColor="#C1C1C1"
                                step={1}
                                onValueChange={(value) => this.setState({ açãp: value })}
                            />
                        </View>
                    </View>
                    ...
                    <View style={styles.containerButton}>
                        ...
                        <View style={styles.containerSlider} >
                            <View style={styles.containerText}>
                                <Text style={styles.textText}> Energia Vital</Text>
                            </View>
                            <Slider
                                style={{ width: 200, height: 40 }}
                                value={this.state.energiaVital}
                                minimumValue={0}
                                maximumValue={100}
                                thumbTintColor="#96B5A6"
                                minimumTrackTintColor="#96B5A6"
                                maximumTrackTintColor="#C1C1C1"
                                step={1}
                                onValueChange={(value) => this.setState({ energiaVital: value })}
                            />
                        </View>
                    </View>
